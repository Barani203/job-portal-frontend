    ...
    <div className='footer'>
        ...
        <div className="footer-newsletter">
            ...
            <form className='form-container text-white'>
                <input className='form-input text-white bg-dark' type="text" placeholder='Enter Your Email' />
                <button className='p-1 m-2'>Submit</button>
            </form>
            ...
            <div className="social-icons">
                {
                    socials_data.map((data,index)=>{
                        return <div key={index} className="social-icon-container" style={{background: data.subcolor}}>
                            <a href="www.skylarkjobs.com"><i className={data.title}></i></a>
                        </div>
                    })
                }
            </div>
